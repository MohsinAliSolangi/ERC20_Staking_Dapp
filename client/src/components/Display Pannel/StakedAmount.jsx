...
const StakedAmount = ()=>{
   const {loader, getProviderStakingContrat,mainAccount}=useContext(Store)
   ...
   useEffect(()=>{
     const fetchStakedBalance = async()=>{
        try{
           const amountStakedWei = await getProviderStakingContrat().stakedBalance(mainAccount)
     ...
     getProviderStakingContrat && fetchStakedBalance()
   },[getProviderStakingContrat, mainAccount,loader])
